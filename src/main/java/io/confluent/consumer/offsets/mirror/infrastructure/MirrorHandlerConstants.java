...
public class MirrorHandlerConstants {
  ...
  public static final String TIMESTAMPS_LOGGER_PERIOD_SYSTEM_PROPERTY = "timestamps-logger-period-secs";
  public static final String TIMESTAMPS_LOGGER_PERIOD_DEFAULT_VALUE = "60";
